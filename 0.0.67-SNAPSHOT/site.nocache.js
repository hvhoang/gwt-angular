...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "site" because\n';
 ...
 * "/site.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['site'].superdevmode = true;

  var expectedSuffix = '/site.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + site + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:site';
  var devModeSessionKey = '__gwtDevModeSession:site';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/site/site.nocache.js';
  ...
  $wnd.__gwt_activeModules['site'].canRedirect = true;
  $wnd.__gwt_activeModules['site'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/site?user.agent=' + ua + '&_callback=' + callback;
