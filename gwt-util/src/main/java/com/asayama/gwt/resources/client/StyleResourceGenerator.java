...
public class StyleResourceGenerator extends AbstractResourceGenerator implements SupportsGeneratorResultCaching {
    ...
    public String createAssignment(TreeLogger logger, ResourceContext context, JMethod method) throws UnableToCompleteException {
        ...
        writer.println("new " + StyleResourcePrototype.class.getName() + "() {");
        {
            writer.indent();
